...
#[inline]
#[must_use]
pub fn is_user_input(context: &LintContext<'_>, expression: &Expression) -> bool {
    match expression {
...
#[inline]
#[must_use]
pub fn is_variable_user_input(context: &LintContext<'_>, variable: &Variable) -> bool {
    match variable {
...
#[inline]
#[must_use]
pub fn get_password(context: &LintContext<'_>, expr: &Expression) -> Option<Span> {
    match expr {
...
#[inline]
#[must_use]
pub fn get_password_from_selector(context: &LintContext<'_>, selector: &ClassLikeMemberSelector) -> Option<Span> {
    match selector {
...
#[inline]
#[must_use]
pub fn get_password_from_variable(context: &LintContext<'_>, variable: &Variable) -> Option<Span> {
    match variable {
        Variable::Direct(direct_variable) => {
            let name = context.interner.lookup(&direct_variable.name);
...
#[inline]
#[must_use]
pub fn is_password_identifier(context: &LintContext<'_>, identifier: &Identifier) -> bool {
...
#[inline]
#[must_use]
pub fn is_password_literal(context: &LintContext<'_>, literal: &LiteralString) -> bool {
...
#[inline]
#[must_use]
pub fn is_password_string(context: &LintContext<'_>, identifier: &StringIdentifier) -> bool {
