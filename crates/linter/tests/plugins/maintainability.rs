...
use mago_linter::plugin::maintainability::rules::long_inheritance_chain::LongInheritanceChainRule;
...
rule_test!(test_long_inheritance_chain, LongInheritanceChainRule);
