...
use mago_linter::plugin::redundancy::rules::redundant_closing_tag::RedundantClosingTagRule;
...
use mago_linter::plugin::redundancy::rules::redundant_mathematical_operation::RedundantMathematicalOperationRule;
...
rule_test!(test_redundant_closing_tag, RedundantClosingTagRule);
...
rule_test!(test_redundant_mathematical_operation, RedundantMathematicalOperationRule);
