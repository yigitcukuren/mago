...
impl ClassLikeMetadata {
    ...
    /// Returns the kind of symbol (Class, Interface, Trait, Enum).
    #[inline]
    pub const fn get_kind(&self) -> SymbolKind {
        self.kind
    }

    /// Checks if this class-like is an interface.
    #[inline]
    pub const fn is_interface(&self) -> bool {
        self.kind.is_interface()
    }

    /// Checks if this class-like is a trait.
    #[inline]
    pub const fn is_trait(&self) -> bool {
        self.kind.is_trait()
    }

    /// Checks if this class-like is a class or trait (i.e., not an interface or enum).
    #[inline]
    pub const fn is_class_or_trait(&self) -> bool {
        self.kind.is_trait() || self.kind.is_class()
    }

    /// Checks if this class-like is an enum.
    #[inline]
    ...
    pub const fn is_backed_enum(&self) -> bool {
        self.is_enum() && self.enum_type.is_some()
    }

    /// Checks if this class-like is a class.
    #[inline]
    pub const fn is_class(&self) -> bool {
        self.kind.is_class()
    }

    /// Checks if this class-like is a specialized instance.
    #[inline]
    pub const fn is_specialized_instance(&self) -> bool {
        self.specialized_instance
    }
    ...
    /// Returns a reference to the ordered map of constants.
    #[inline]
    pub fn get_constants(&self) -> &IndexMap<StringIdentifier, ClassLikeConstantMetadata, RandomState> {
        &self.constants
    }

    /// Returns a mutable reference to the ordered map of constants.
    #[inline]
    pub fn get_constants_mut(&mut self) -> &mut IndexMap<StringIdentifier, ClassLikeConstantMetadata, RandomState> {
        &mut self.constants
    }

    /// Returns a reference to a specific constant by its name.
    #[inline]
    pub fn get_constant(&self, name: &StringIdentifier) -> Option<&ClassLikeConstantMetadata> {
        self.constants.get(name)
    }

    /// Checks if a specific constant exists.
    #[inline]
    pub fn has_constant(&self, name: &StringIdentifier) -> bool {
        self.constants.contains_key(name)
    }

    /// Returns a reference to the ordered map of enum cases.
    #[inline]
    pub fn get_enum_cases(&self) -> &IndexMap<StringIdentifier, EnumCaseMetadata, RandomState> {
        &self.enum_cases
    }

    /// Returns a mutable reference to the ordered map of enum cases.
    #[inline]
    pub fn get_enum_cases_mut(&mut self) -> &mut IndexMap<StringIdentifier, EnumCaseMetadata, RandomState> {
        &mut self.enum_cases
    }

    /// Returns a reference to a specific enum case by its name.
    #[inline]
    pub fn get_enum_case(&self, name: &StringIdentifier) -> Option<&EnumCaseMetadata> {
        self.enum_cases.get(name)
    }

    /// Checks if a specific enum case exists.
    #[inline]
    pub fn has_enum_case(&self, name: &StringIdentifier) -> bool {
    ...
    /// Checks if this is an abstract class or interface.
    #[inline]
    pub const fn is_abstract(&self) -> bool {
        self.is_abstract
    }

    /// Checks if this is a final class.
    #[inline]
    pub const fn is_final(&self) -> bool {
        self.is_final
    }

    /// Checks if this class is marked `@psalm-immutable`.
    #[inline]
    pub const fn is_immutable(&self) -> bool {
        self.is_immutable
    }

    /// Checks if this class is marked `readonly`.
    #[inline]
    pub const fn is_readonly(&self) -> bool {
        self.is_readonly
    }

    /// Checks if this class-like is marked `@deprecated`.
    #[inline]
    pub const fn is_deprecated(&self) -> bool {
        self.is_deprecated
    }

    /// Checks if this class-like is marked `@internal`.
    #[inline]
    pub const fn is_internal(&self) -> bool {
        self.is_internal
    }

    /// Checks if this class is marked `@psalm-mutation-free`.
    #[inline]
    pub const fn is_mutation_free(&self) -> bool {
        self.is_mutation_free
    }

    /// Checks if this class is marked `@psalm-external-mutation-free`.
    #[inline]
    pub const fn is_external_mutation_free(&self) -> bool {
        self.is_external_mutation_free
    }

    /// Checks if this class is marked `@psalm-allow-private-mutation`.
    #[inline]
    pub const fn allows_private_mutation(&self) -> bool {
        self.allows_private_mutation
    }

    /// Does this class maintain constructor consistency with parents?
    #[inline]
    pub const fn has_consistent_constructor(&self) -> bool {
        self.has_consistent_constructor
    }

    /// Do template/generic parameter bounds align consistently with parents?
    #[inline]
    pub const fn has_consistent_templates(&self) -> bool {
        self.has_consistent_templates
    }
    ...
    /// Sets whether this class-like is abstract.
    #[inline]
    ...
    /// Sets whether this class-like is final.
    #[inline]
    pub fn set_is_final(&mut self, is_final: bool) {
        self.is_final = is_final;
    }

    /// Returns a new instance with the final flag set.
    #[inline]
    pub fn with_is_final(mut self, is_final: bool) -> Self {
        self.set_is_final(is_final);
        self
    }

    /// Sets whether this class-like is immutable (`@psalm-immutable`).
    #[inline]
    pub fn set_is_immutable(&mut self, is_immutable: bool) {
        self.is_immutable = is_immutable;
    }

    /// Returns a new instance with the immutable flag set.
    #[inline]
    pub fn with_is_immutable(mut self, is_immutable: bool) -> Self {
        self.set_is_immutable(is_immutable);
        self
    }

    /// Sets whether this class-like is readonly (PHP 8.2+).
    #[inline]
    ...
    /// Sets whether this class-like is deprecated.
    #[inline]
    ...
    /// Sets whether this class-like is internal (`@internal`).
    #[inline]
    ...
    /// Sets whether this class-like is mutation-free. Updates related flags.
    #[inline]
    ...
    /// Returns a new instance with the mutation-free flag set. Updates related flags.
    #[inline]
    ...
    /// Sets whether this class-like is external-mutation-free.
    #[inline]
    pub fn set_is_external_mutation_free(&mut self, is_external_mutation_free: bool) {
        ...
        if !is_external_mutation_free {
            self.is_mutation_free = false;
        }
    }
    ...
    /// Sets whether private mutations are allowed (`@psalm-allow-private-mutation`).
    #[inline]
    pub fn set_allows_private_mutation(&mut self, allows: bool) {
        self.allows_private_mutation = allows;
    }

    /// Returns a new instance with the allows-private-mutation flag set.
    #[inline]
    pub fn with_allows_private_mutation(mut self, allows: bool) -> Self {
        self.set_allows_private_mutation(allows);
        self
    }

    /// Sets whether the constructor signature is consistent with parents.
    #[inline]
    pub fn set_has_consistent_constructor(&mut self, has_consistent: bool) {
        self.has_consistent_constructor = has_consistent;
    }

    /// Returns a new instance with the consistent constructor flag set.
    #[inline]
    pub fn with_has_consistent_constructor(mut self, has_consistent: bool) -> Self {
        self.set_has_consistent_constructor(has_consistent);
        self
    }

    /// Sets whether template bounds are consistent with parents.
    #[inline]
    pub fn set_has_consistent_templates(&mut self, has_consistent: bool) {
        self.has_consistent_templates = has_consistent;
    }

    /// Returns a new instance with the consistent templates flag set.
    #[inline]
    pub fn with_has_consistent_templates(mut self, has_consistent: bool) -> Self {
        self.set_has_consistent_templates(has_consistent);
        self
    }
