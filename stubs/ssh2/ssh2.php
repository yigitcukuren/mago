 ...
 */
function ssh2_connect($host, $port = 22, null|array $methods = null, null|array $callbacks = null)
{
}
 ...
 * @return bool true on success or false on failure.
 */
function ssh2_publickey_add($pkey, $algoname, $blob, $overwrite = null, null|array $attributes = null)
{
}
