 ...
 * stream.
 */
function gzwrite($stream, string $data, null|int $length): int|false
{
}
 ...
 * @return int|false
 */
function gzputs($stream, string $data, null|int $length): int|false
{
}
...
function deflate_init(
    int $encoding,
    #[LanguageLevelTypeAware(['8.3' => 'array|object'], default: 'array')]  $options = [],
) {
}
