 ...
 * @since 7.2
 */
function ftp_append(mixed $ftp, string $remote_filename, string $local_filename, int $mode = FTP_BINARY): bool
{
}
...
function ftp_get(
    ...
    #[PhpStormStubsElementAvailable(from: '5.3', to: '7.2')] int $mode,
    #[EV([FTP_ASCII, FTP_BINARY])]
    #[PhpStormStubsElementAvailable(from: '7.3')] int $mode = FTP_BINARY,
    int $offset = 0,
): bool {
}
